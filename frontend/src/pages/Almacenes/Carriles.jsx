    ...
    <div className="min-w-0 max-w-full">
      <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-3 sm:gap-4 mb-4">
        <button
          type="button"
          onClick={volver}
          className="inline-flex items-center justify-center gap-2 min-h-[44px] w-full sm:w-auto px-4 py-2.5 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600"
        >
          <ArrowLeft className="w-4 h-4 shrink-0" />
          Regresar
        </button>
        <div className="flex items-start gap-3 min-w-0">
          <LayoutGrid className="w-7 h-7 sm:w-8 sm:h-8 text-primary-600 shrink-0" />
